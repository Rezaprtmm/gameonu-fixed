...
export default function CardTopRight({ number, step, description, link }) {
    return (
        <div className="w-full flex flex-row items-center justify-center mt-[100px]">
            <div className="w-[45%] flex flex-col items-end justify-center">
                <hr className="w-[462px] bg-black h-[3px]" />
            </div>
            <div className="w-[10%] flex items-center justify-center">
                <hr className="w-[3px] h-[48px] bg-black absolute mb-[170px]" />
            ...
            <div className="w-[45%] flex flex-col -mb-[45px]">
