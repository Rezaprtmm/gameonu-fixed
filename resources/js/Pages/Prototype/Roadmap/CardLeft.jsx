...
export default function CardLeft({
    ...
    return (
        <div
            className={`w-full flex flex-row items-center justify-center mt-[150px] ${className2}`}
        >
            <div className={`w-[45%] flex flex-col -mb-[45px] ${className}`}>
                <div className="bg-white w-[400px] border-secondary border-[3px] ml-[30px] shadow-custom1">
                ...
                <div className="ml-[30px] mt-[30px] w-[200px] -mb-[30px]">
                    <Link
                        href={link}
                ...
                <hr className="w-[38px] h-[3px] bg-black absolute mt-[100px] ml-[460px]" />
            </div>
            ...
            <div className="w-[45%] flex flex-col items-end justify-center">
                <hr className="w-[462px] bg-black h-[3px] mr-[35px]" />
            </div>
        </div>
    );
}
